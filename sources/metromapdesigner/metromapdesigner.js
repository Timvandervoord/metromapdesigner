...
export default class metromapdesigner {
    ...
    setMapEventListeners() {
      ...
      svgelement.addEventListener("touchleave", this.mouseUpCanvas);
    ...
    metroMapReplaceLogo(data) {
      ...
      img.onload = () => {
          try {
              ...
              imgLogo.setAttributeNS("http://www.w3.org/1999/xlink", "href", data);
     ...
     */
    loadMapWithShareCode(code) {
      let svgContent = this.importExport.retrieveSharedCanvas(code);
      if(svgContent) this.loadMap(svgContent);
      else throw new Error("Metrokaart bestaat niet of is verlopen", "danger");
    }
